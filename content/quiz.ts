...
export const quizResults = {
  ...
  career: {
    title: 'Вам подойдёт профнавигация',
    description:
      'Вы ищете свой путь или следующий шаг в профессии. Профнавигация поможет прояснить цели и найти направление.',
    cta: 'Записаться на сессию профнавигации',
    href: '/zapis/',
  },
  coaching: {
    title: 'Вам подойдёт сопровождение бизнес-лидеров',
    description:
      'У вас есть цель, и вы хотите её достичь. Индивидуальное сопровождение поможет выстроить стратегию и убрать то, что мешает двигаться вперёд.',
