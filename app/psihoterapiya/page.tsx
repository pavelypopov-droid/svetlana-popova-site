...
export const metadata: Metadata = generatePageMetadata({
  ...
  description: 'Помогу справиться с тревогой, депрессией, выгоранием и трудностями в отношениях. Онлайн и очно в Москве.',
  path: '/psihoterapiya/',
})
...
export default function PsihoterapiyaPage() {
  ...
  return (
    <>
      <ServiceHero
        badge="Психотерапия"
        title="Место, где вас слышат. Без осуждения."
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <Card className="text-center">
              ...
              <h3 className="font-bold text-brand-dark mb-2">Очно в Москве</h3>
