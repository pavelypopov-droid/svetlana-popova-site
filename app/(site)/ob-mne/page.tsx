        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex flex-col md:flex-row gap-10 items-start">
            <div className="flex-1">
              ...
              <p className="text-brand-dark/70 leading-relaxed mb-4">
                За 18 лет практики я работала с самыми разными запросами: от острой тревоги и панических атак до профессиональных кризисов и управленческих задач. Я вижу, как глубоко изнутри меняются люди, когда чувствуют себя услышанными и понятыми. Это и есть то, ради чего я работаю.
              </p>
