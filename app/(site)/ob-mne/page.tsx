        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex flex-col md:flex-row gap-10 items-start">
            <div className="flex-1">
              ...
              <p className="text-brand-dark/70 leading-relaxed mb-4">
                Меня захватывала не картинка, а глубина — что чувствует человек, почему он так поступает, что стоит за его словами. Пока другие дети проживали сюжеты, я проживала психологию.
              </p>
              <p className="text-brand-dark/70 leading-relaxed mb-4">
